...
PRODUCT_COPY_FILES += \
    ...
    $(LOCAL_PATH)/media/lahaina/media_codecs_system_default_lahaina.xml:$(TARGET_COPY_OUT_VENDOR)/etc/media_codecs_lahaina.xml \
...
PRODUCT_COPY_FILES += \
    ...
    $(LOCAL_PATH)/media/shima/media_codecs_system_default_shima.xml:$(TARGET_COPY_OUT_VENDOR)/etc/media_codecs_shima_v1.xml \
...
PRODUCT_COPY_FILES += \
    $(LOCAL_PATH)/configs/telephony_system-ext-privapp-permissions-qti.xml:$(TARGET_COPY_OUT_SYSTEM_EXT)/etc/permissions/telephony_system-ext-privapp-permissions-qti.xml
